...
// User Variables - Define your data as a struct for easier handling
struct UserSettings {
  ...
  float PressureTarget = 25;        // Target Sprayer pressure
...
// Software switches
bool sprayerOn = false;     // Main Switch
